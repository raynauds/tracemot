...
//   - le DOM lit les variables CSS de src/theme/tokens.css — fichier GÉNÉRÉ
//     depuis ce module (`npm run generate:tokens`), jamais édité à la main ;
//   - Pixi attend des nombres (0xRRGGBB) : src/game/config.ts les dérive via
...
export const COLORS = {
  ...
  // Carte de progression : un papier plus sourd que celui du jeu, pour que
  // l'accueil et la partie ne se confondent jamais.
  "map-paper": "#efe9da",
